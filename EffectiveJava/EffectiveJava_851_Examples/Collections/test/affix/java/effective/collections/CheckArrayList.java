...
public class CheckArrayList {
	...
	public CheckArrayList(){
		theCollection = new CountryCollection("List");
		System.out.println("========================================================");
	...
	public void testGetNoOfObjects() {
		...
		assertEquals(10, theCollection.getNoOfCountries());
//		theCollection.printAllCountries();
	}
	...
	public void testAddObject() {
		...
		assertEquals(theCollection.containsCountry(test), true);
//		theCollection.printAllCountries();
	}
...
//		theCollection.printAllCountries();
	...
	public void testRemoveObject() {
		...
		assertEquals(theCollection.removeCountry(test), true);
		System.out.println("--- Assert removed object is not in collection --- ");
		assertEquals(theCollection.containsCountry(test), false);
//		theCollection.printAllCountries();
	}
	...
	public void testRemoveNonexistingObject() {
		...
		assertEquals(theCollection.removeCountry(test), false);
//		theCollection.printAllCountries();
	}
